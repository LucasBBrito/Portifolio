      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.h2
            ...
            className="text-2xl md:text-3xl font-semibold italic mb-4 h-10"
            style={{
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-b from-primary/30 to-accent/20 rounded-lg blur-xl"
              animate={{
                scale: [1, 1.1, 1],
                opacity: [0.5, 0.8, 0.5],
              }}
            ...
            >
              ...
              {/* Corner accent */}
              <motion.div
                className="absolute -bottom-2 -right-2 w-4 h-4 border-r-2 border-b-2 border-primary"
...
const Timeline = () => {
  ...
  return (
    <div ref={timelineRef} className="relative mt-16 max-w-4xl mx-auto">
      ...
      <motion.div
        className="absolute left-1/2 top-0 w-0.5 bg-gradient-to-b from-primary via-accent to-primary -translate-x-1/2 origin-top"
      ...
      <div className="space-y-12">
        {experiences.map((exp, index) => (
          ...
          >
            {/* Content */}
            <motion.div
              className={`flex-1 ${exp.side === "left" ? "text-right" : "text-left"}`}
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.2 }}
            >
              <motion.span
                className="inline-block px-3 py-1 rounded-full text-sm bg-green-accent/20 text-green-accent border border-green-accent/30 mb-2"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
